          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                title: Text(snapshot.data![index].nome), // Título do item
                subtitle:
                Text(snapshot.data![index].especialidade), // Descrição do item
                trailing: IconButton(
          ...
          children: [
            TextField(
              ...
              decoration: InputDecoration(
                  labelText: 'Nome'), // Decoração do campo de texto
            ),
            TextField(
              ...
              decoration: InputDecoration(
                  labelText: 'Especialidade'), // Decoração do campo de texto
            ),
          ],
        ),
        actions: [
          ...
          TextButton(
            ...
            onPressed: () {
              ...
              final tarefa = Tarefa(
                ...
                nome: titleController.text, // Título da tarefa
                especialidade: descriptionController.text, // Descrição da tarefa
              );
              dbHelper
